...
const client = mqtt.connect('tailor.cloudmqtt.com', {
  username: 'aqrrjrij',
...
app.post('/webhook', async (req, res) => {
  ...
  const TOKEN = `NBMBWmeqf/S/qYFCJ7zhzyf1F8FXd/eDnFoB9WvNSF4F7aXg8XS6RnIiMyQtEaVj4Uq7don6y8BlDwneOFFpwiwi6osJv1R4y8AzorlZu7z7NBP8hFpO4XPgf4WsgNGlczM6zpPPlaqus3fIwODq0QdB04t89/1O/w1cDnyilFU=`;
  const HEADERS = {
